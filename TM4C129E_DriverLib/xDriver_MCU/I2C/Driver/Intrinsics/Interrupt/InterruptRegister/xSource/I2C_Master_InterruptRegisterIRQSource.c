...
I2C_nERROR I2C_Master__enRegisterIRQSourceHandler(I2C_nMODULE enModuleArg, I2C_nMASTER_INT enInterruptSourceArg, I2C_pvfIRQSourceHandler_t pfIrqSourceHandler)
{
    ...
    {
        enErrorReg = (I2C_nERROR) MCU__enCheckParams((UBase_t) enInterruptSourceArg, (UBase_t) I2C_enMASTER_INT_MAX);
    }
    if(I2C_enERROR_OK == enErrorReg)
    {
        I2C_pvfIRQSourceHandler_t* pvfIrqHandler = I2C_Master__pvfGetIRQSourceHandlerPointer(enModuleArg, enInterruptSourceArg);
