    ...
    else
    {
        ...
        else
        {
            ...
            if(uxReg & ADC_ISC_R_DCINSS0_MASK)
            {
                ...
                uxRegCompMux = ADC1_SS0_DC_R;
                uxRegCompSelect = ADC1_SS0_OP_R;
                uxShiftReg = 0x1UL;
                    ...
                    if(uxRegCompSelect & uxShiftReg)
                    {
                        ...
                        if(uxRegCompInterrupt & uxRegCompMuxBit)
                        {
                            ...
                            if(uxRegCompEnable & ADC_DC_CTL_R_CIE_MASK)
                            {
                                ...
                                pvfCallback = ADC_Comparator__pvfGetIRQSourceHandler(ADC_enMODULE_1, ADC_enSEQ_0, (ADC_nCOMPARATOR) uxTempReg);
