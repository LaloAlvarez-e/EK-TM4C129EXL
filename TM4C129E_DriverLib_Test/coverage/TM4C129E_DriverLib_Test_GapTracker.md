...
| Peripheral ACMP | `xDriver_MCU/ACMP/Driver/Intrinsics/Interrupt/InterruptRoutine/xSource/ACMP_InterruptRoutine_Source.c` | `ACMP_InterruptRoutine_Source_Test` | `covered` | Current target validates default-handler exposure, invalid getter and pointer rejection, and writable slot exposure across the ACMP SW and comparator routine-source tables. |
| Peripheral ADC | `xDriver_MCU/ADC/Driver/Intrinsics/Interrupt/InterruptRoutine/xSource/ADC_InterruptRoutine_Source.c` | `ADC_InterruptRoutine_Source_Test` | `covered` | Current target validates default-handler exposure, invalid getter and pointer rejection, and writable slot exposure across the ADC SW, sequencer, and comparator routine-source tables. |
| Peripheral DMA | `xDriver_MCU/DMA/Driver/Intrinsics/Interrupt/InterruptRoutine/xSource/DMA_InterruptRoutine_Source_Software.c` | `DMA_InterruptRoutine_Source_Software_Test` | `covered` | Current target validates default-handler exposure, invalid getter and pointer rejection, and writable slot exposure across the DMA error and software routine-source tables. |
| Peripheral EEPROM | `xDriver_MCU/EEPROM/Driver/Intrinsics/Interrupt/InterruptRoutine/xSource/EEPROM_InterruptRoutine_Source.c` | `EEPROM_InterruptRoutine_Source_Test` | `covered` | Current target validates default-handler exposure, invalid getter and pointer rejection, and writable slot exposure across the EEPROM routine-source table. |
| Peripheral FLASH | `xDriver_MCU/FLASH/Driver/Intrinsics/Interrupt/InterruptRoutine/xSource/FLASH_InterruptRoutine_Source.c` | `FLASH_InterruptRoutine_Source_Test` | `covered` | Current target validates default-handler exposure, invalid getter and pointer rejection, and writable slot exposure across the FLASH routine-source table. |
| Peripheral GPIO | `xDriver_MCU/GPIO/Driver/Intrinsics/Interrupt/InterruptRoutine/xSource/GPIO_InterruptRoutine_Source.c` | `GPIO_InterruptRoutine_Source_Test` | `covered` | Current target validates default-handler exposure, invalid getter and pointer rejection, and writable slot exposure across the GPIO general, DMA, SW, and PQ routine-source tables. |
| Peripheral HIB | `xDriver_MCU/HIB/Driver/Intrinsics/Interrupt/InterruptRoutine/xSource/HIB_InterruptRoutine_Source.c` | `HIB_InterruptRoutine_Source_Test` | `covered` | Current target validates default-handler exposure, invalid getter and pointer rejection, and writable slot exposure across the HIB routine-source table. |
| Peripheral I2C | `xDriver_MCU/I2C/Driver/Intrinsics/Interrupt/InterruptRoutine/xSource/I2C_Master_InterruptRoutine_Source.c` | `I2C_Master_InterruptRoutine_Source_Test` | `covered` | Current target validates default-handler exposure, invalid getter and pointer rejection, and writable slot exposure across the I2C master routine-source table. |
| Peripheral I2C | `xDriver_MCU/I2C/Driver/Intrinsics/Interrupt/InterruptRoutine/xSource/I2C_Slave_InterruptRoutine_Source.c` | `I2C_Slave_InterruptRoutine_Source_Test` | `covered` | Current target validates default-handler exposure, invalid getter and pointer rejection, and writable slot exposure across the I2C slave routine-source table. |
| Peripheral PWM | `xDriver_MCU/PWM/Driver/Intrinsics/Interrupt/InterruptRoutine/xSource/PWM_InterruptRoutine_Source.c` | `PWM_InterruptRoutine_Source_Test` | `covered` | Current target validates default-handler exposure, invalid getter and pointer rejection, and writable slot exposure across the PWM generator, fault SW, fault input, and fault digital-comparator routine-source tables. |
| Peripheral QEI | `xDriver_MCU/QEI/Driver/Intrinsics/Interrupt/InterruptRoutine/xSource/QEI_InterruptRoutine_Source.c` | `QEI_InterruptRoutine_Source_Test` | `covered` | Current target validates default-handler exposure, invalid getter and pointer rejection, and writable slot exposure across the QEI routine-source table. |
| Peripheral SSI | `xDriver_MCU/SSI/Driver/Intrinsics/Interrupt/InterruptRoutine/xSource/SSI_InterruptRoutine_Source.c` | `SSI_InterruptRoutine_Source_Test` | `covered` | Current target validates default-handler exposure, invalid getter and pointer rejection, and writable slot exposure across the SSI routine-source table. |
| Chapter 6 SYSEXC | `xDriver_MCU/SYSEXC/Driver/Intrinsics/Interrupt/InterruptRoutine/xSource/SYSEXC_InterruptRoutine_Source.c` | `SYSEXC_InterruptRoutine_Source_Test` | `covered` | Current target validates default-handler exposure, invalid getter and pointer rejection, and writable slot exposure across the SYSEXC routine-source table. |
| Peripheral UART | `xDriver_MCU/UART/Driver/Intrinsics/Interrupt/InterruptRoutine/xSource/UART_InterruptRoutine_Source.c` | `UART_InterruptRoutine_Source_Test` | `covered` | Current target validates default-handler exposure, invalid getter and pointer rejection, and writable slot exposure across the UART routine-source table. |
| Peripheral WDT | `xDriver_MCU/WDT/Driver/Intrinsics/Interrupt/InterruptRoutine/xSource/WDT_InterruptRoutine_Source.c` | `WDT_InterruptRoutine_Source_Test` | `covered` | Current target validates default-handler exposure, invalid getter and pointer rejection, and writable slot exposure across the WDT routine-source table. |
...
- validates getter rejection for out-of-range SYSCTL interrupt-source selections
- validates pointer-helper rejection for out-of-range SYSCTL interrupt-source selections
- validates that the pointer getter exposes writable source-slot storage and that unrelated slots remain unchanged

### Mirrored Peripheral InterruptRoutineSource Suites

- `ACMP_InterruptRoutine_Source_Test`, `ADC_InterruptRoutine_Source_Test`, `DMA_InterruptRoutine_Source_Software_Test`, `GPIO_InterruptRoutine_Source_Test`, and `PWM_InterruptRoutine_Source_Test` validate default-handler exposure, invalid getter and pointer rejection, and writable slot exposure across their multi-family routine-source tables.
- `EEPROM_InterruptRoutine_Source_Test`, `FLASH_InterruptRoutine_Source_Test`, `HIB_InterruptRoutine_Source_Test`, `I2C_Master_InterruptRoutine_Source_Test`, `I2C_Slave_InterruptRoutine_Source_Test`, `QEI_InterruptRoutine_Source_Test`, `SSI_InterruptRoutine_Source_Test`, `SYSEXC_InterruptRoutine_Source_Test`, `UART_InterruptRoutine_Source_Test`, and `WDT_InterruptRoutine_Source_Test` apply the same guard and writable-slot coverage to their single-family routine-source tables.
